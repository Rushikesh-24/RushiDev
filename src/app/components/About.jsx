...
const About = () => {
  ...
  return (
    <div className="md:mt-40 flex justify-center items-center md:mb-96 flex-col mt-10 mb-10" id="about">
        <h1 className={`${playFair.className} md:text-9xl text-5xl mb-20`}>About</h1>
        <motion.p
        ...
        >
          ...
          development, I'm committed to mastering the art of code. My ambition
          is to evolve into a versatile Software Developer, merging my technical
          ...
          learning and a proactive approach, I aim to contribute significantly
